...
using FinalProjectSoftware.Repository;
...
namespace FinalProjectSoftware
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IJobRole, JobRoleRepository>();
            services.AddScoped<IActivity, ActivityRepository>();
            services.AddScoped<IPlacement, PlacementRepository>();
            services.AddScoped<IStatus, StatusRepository>();
            services.AddScoped<IRemark, RemarkRepository>();
